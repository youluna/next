...
var Filter = (_temp = _class = function (_React$Component) {
    ...
    Filter.prototype.render = function render() {
        ...
        var subMenuSelectable = filterMenuProps.subMenuSelectable,
            others = (0, _objectWithoutProperties3.default)(filterMenuProps, ['subMenuSelectable']);
        ...
        var cls = (0, _classnames3.default)((_classnames = {}, _classnames[prefix + 'table-filter'] = true, _classnames[className] = className, _classnames));

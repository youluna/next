    ...
    var FixedTable = (_temp2 = _class = function (_React$Component) {
        ...
        function FixedTable() {
            ...
            return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.getNode = function (type, node, lockType) {
                ...
                var _current$target = current.target,
                    scrollLeft = _current$target.scrollLeft,
                    scrollTop = _current$target.scrollTop;

                if (current.target === _this.bodyNode) {
                    if (_this.bodyNode && scrollTop !== _this.bodyNode.scrollTop) {
                        _this.bodyNode.scrollTop = scrollTop;
                    }
                    if (_this.headerNode && scrollLeft !== _this.headerNode.scrollLeft) {
                        _this.headerNode.scrollLeft = scrollLeft;
                    }
                } else if (current.target === _this.headerNode) {
                    if (_this.bodyNode && scrollLeft !== _this.bodyNode.scrollLeft) {
                        _this.bodyNode.scrollLeft = scrollLeft;
                    }
                }
        ...
        FixedTable.prototype.adjustFixedHeaderSize = function adjustFixedHeaderSize() {
            ...
            if (hasHeader && !this.props.lockType && body) {
                ...
                var scrollBarSize = _util.dom.scrollbar().width;
        ...
        FixedTable.prototype.render = function render() {
            ...
            var _props2 = this.props,
                ...
                others = (0, _objectWithoutProperties3.default)(_props2, ['components', 'className', 'prefix', 'fixedHeader', 'lockType', 'maxBodyHeight']);
            ...
            return _react2.default.createElement(BaseComponent, (0, _extends3.default)({}, others, event, {
                lockType: lockType,

    ...
    var FixedTable = (_temp2 = _class = function (_React$Component) {
        ...
        FixedTable.prototype.adjustFixedHeaderSize = function adjustFixedHeaderSize() {
            ...
            if (hasHeader && !this.props.lockType && body) {
                ...
                var scrollBarSize = dom.scrollbar().width;
        ...
        FixedTable.prototype.render = function render() {
            ...
            var _props2 = this.props,
                ...
                others = _objectWithoutProperties(_props2, ['components', 'className', 'prefix', 'fixedHeader', 'lockType', 'maxBodyHeight']);
            ...
            return React.createElement(BaseComponent, _extends({}, others, event, {
                lockType: lockType,
